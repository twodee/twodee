...
#define GRAYSCALE_ALPHA Magick::GrayscaleAlphaType
#else
#define GRAYSCALE_ALPHA Magick::GrayscaleMatteType
#endif

    else if (image.type() == GRAYSCALE_ALPHA) {
      magick_nchannels = 2;
    }

#undef GRAYSCALE_ALPHA
